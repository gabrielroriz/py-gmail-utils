...
def create_service(client_secret_file, api_name, api_version, scopes, token_file='token.json'):
    """
        ...
        for part in payload['parts']:
            if part['mimeType'] == 'multipart/alternative':
                for subpart in part['parts']:
                    if subpart['mimeType'] == 'text/plain' and 'data' in part['body']:
...
def add_label_to_email(service, msg_id, label_id, user_id='me'):
    """
...
def archive_email(service, msg_id, user_id='me'):
    """
